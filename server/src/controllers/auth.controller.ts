...
const registerUser = asyncHandler<RegisterInput, EmptyQuery, EmptyParams, AuthResponse>(
...
const loginUser = asyncHandler<LoginInput, EmptyQuery, EmptyParams, AuthResponse>(
  async (req: Request, res: Response<AuthResponse>) => {
